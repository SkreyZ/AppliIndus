...
public:
    ...
    QPushButton *pushButton_Affiche_Carac;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_Affiche_Carac = new QPushButton(widget_2);
        pushButton_Affiche_Carac->setObjectName(QString::fromUtf8("pushButton_Affiche_Carac"));

        verticalLayout->addWidget(pushButton_Affiche_Carac);

        pushButton_normales_points = new QPushButton(widget_2);
        pushButton_normales_points->setObjectName(QString::fromUtf8("pushButton_normales_points"));

        verticalLayout->addWidget(pushButton_normales_points);

        pushButton_normales_faces = new QPushButton(widget_2);
        pushButton_normales_faces->setObjectName(QString::fromUtf8("pushButton_normales_faces"));

        verticalLayout->addWidget(pushButton_normales_faces);

        pushButton_seuls = new QPushButton(widget_2);
        pushButton_seuls->setObjectName(QString::fromUtf8("pushButton_seuls"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_Affiche_Carac->setText(QCoreApplication::translate("MainWindow", "Afficher Caract\303\251ristiques", nullptr));
